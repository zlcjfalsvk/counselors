				...
				<tr>
					<div class="form-group">
						...
						<td><input type="text" name="title" class="form-control"
							value='${counselorVO.title}'></td>
					</div>
				</tr>
				<tr>
					<div class="form-group">
						<td><label>작성자</label></td>
						<td><input type="text" name="register" class="form-control"
							value='${counselorVO.register}'></td>
					</div>
				</tr>
				<tr>
					<div class="form-group">
				...
				<tr>
					<div class="form-group">
						...
						<td><textarea name="content" class="form-control" rows="10"
								value='${counselorVO.content}'></textarea></td>
					</div>
				</tr>
